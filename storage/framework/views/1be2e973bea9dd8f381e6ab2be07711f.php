                    ...
                    <div class="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($walletAttentionTotal > 0.004): ?>
                            <div class="rounded-2xl bg-white/90 p-4 ring-1 ring-sky-100">
                                ...
                                <p class="mt-1 text-xl font-black text-sky-950">£<?php echo e(number_format($walletAttentionTotal, 2)); ?></p>
                                <p class="mt-1 text-sm font-semibold leading-5 text-sky-900">Generated from <?php echo e($walletAttentionSources->isNotEmpty() ? $walletAttentionSources->implode(' and ') : 'this order history'); ?>. Staff should inform the customer.</p>
                            </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($walletCreditFromRevisions > 0.004): ?>
                            <div class="rounded-2xl bg-white/90 p-4 ring-1 ring-violet-100">
                                ...
                                <p class="mt-1 text-xl font-black text-violet-950">£<?php echo e(number_format($walletCreditFromRevisions, 2)); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($needsAttentionItems > 0): ?>
                            <div class="rounded-2xl bg-white/90 p-4 ring-1 ring-rose-100">
                                ...
                                <p class="mt-1 text-xl font-black text-rose-950"><?php echo e($needsAttentionItems); ?> item<?php echo e($needsAttentionItems === 1 ? '' : 's'); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($arrivalIssueItems > 0): ?>
                            <div class="rounded-2xl bg-white/90 p-4 ring-1 ring-orange-100">
                                ...
                                <p class="mt-1 text-xl font-black text-orange-950"><?php echo e($arrivalIssueItems); ?> item<?php echo e($arrivalIssueItems === 1 ? '' : 's'); ?></p>
