        ...
        <div x-show="tab === 'purchase_status'" x-cloak class="space-y-5">
            <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <a href="<?php echo e(route('purchasing.orders.show', $order->id)); ?>" class="rounded-2xl bg-indigo-600 px-4 py-2 text-sm font-black text-white shadow-sm hover:bg-indigo-700">Open Purchasing Workspace ↗</a>
                </div>
