...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> Orders <?php $__env->endSlot(); ?>
    ...
    <div class="space-y-4">
        <div class="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <form method="GET" action="<?php echo e(route('orders.index')); ?>" data-live-search-form class="space-y-4">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div class="flex min-w-0 flex-wrap items-center gap-3">
                        ...
                        <span class="rounded-full px-3 py-1 text-xs font-black uppercase tracking-wide ring-1 <?php echo e($currentModeClass); ?>"><?php echo e($currentModeLabel); ?></span>
                    </div>
                    <p class="text-sm font-black text-slate-500"><?php echo e(number_format($orders->total())); ?> orders</p>
                </div>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="h-[46px] w-full rounded-2xl border-slate-300 px-4 text-sm font-bold text-slate-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" data-live-search-submit>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($status); ?>" <?php if($filters['status'] === $status): echo 'selected'; endif; ?>><?php echo e(match($status) { 'paid' => 'Paid', 'unpaid' => 'Unpaid', 'purchased' => 'Purchased', 'arrived' => 'Arrived', 'partially_purchased' => 'Partially purchased', 'customer_informed' => 'Customer informed', 'cancelled' => 'Cancelled', 'canceled' => 'Cancelled', default => str_replace('_', ' ', ucfirst($status)) }); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>

                    <div class="flex flex-wrap items-center gap-2 xl:justify-end">
                        <label class="inline-flex h-[42px] cursor-pointer items-center justify-center gap-2 rounded-2xl border px-4 text-sm font-black shadow-sm <?php echo e(! empty($filters['mine']) ? 'border-indigo-200 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50'); ?>">
                            <input type="checkbox" name="mine" value="1" <?php if(! empty($filters['mine'])): echo 'checked'; endif; ?> data-live-search-submit class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500">
                            Mine
                        </label>
                        <label class="inline-flex h-[42px] cursor-pointer items-center justify-center gap-2 rounded-2xl border px-4 text-sm font-black shadow-sm <?php echo e(! empty($filters['show_history']) ? 'border-amber-200 bg-amber-50 text-amber-700' : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50'); ?>">
                            <input type="checkbox" name="show_history" value="1" <?php if(! empty($filters['show_history'])): echo 'checked'; endif; ?> data-live-search-submit class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500">
                            History
                        </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filters['q'] || $filters['status'] || ! empty($filters['mine']) || ! empty($filters['show_history'])): ?>
                            <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex h-[42px] items-center justify-center rounded-2xl bg-slate-100 px-4 text-sm font-black text-slate-600 hover:bg-slate-200">Clear</a>
        ...
        <div class="space-y-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orders->count()): ?>
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(250px,1.35fr)_180px_190px_minmax(320px,1.2fr)_360px] xl:items-center">
                        <div class="min-w-0">
                            <div class="flex flex-wrap items-center gap-2">
                                <h3 class="text-lg font-black leading-tight text-slate-950">Order #<?php echo e($order->order_number); ?></h3>
                                <span class="rounded-full px-2.5 py-1 text-[10px] font-black uppercase tracking-wide <?php echo e($paymentBadgeClass); ?>"><?php echo e($paymentLabel); ?></span>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLegacyException): ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revisionTotal > 1): ?>
                                    <span class="rounded-full bg-indigo-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-indigo-700">Rev <?php echo e($order->revision_number ?? 1); ?>/<?php echo e($revisionTotal); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <p class="mt-2 truncate text-xl font-black text-slate-900">
                                <a href="<?php echo e(route('customers.show', $order->customer_id)); ?>" class="hover:text-indigo-700 hover:underline"><?php echo e($customerName); ?></a>
                            </p>
                            <p class="mt-1 truncate text-xs font-semibold text-slate-400">
                                <?php echo e($order->created_at ? \Carbon\Carbon::parse($order->created_at)->format('d M Y H:i') : 'No date'); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->bill_to_email): ?>
                                    · <?php echo e($order->bill_to_email); ?>
                        ...
                        <div class="border-slate-200 xl:border-l xl:pl-5">
                            ...
                            <div class="mt-2 flex items-center gap-2 text-sm font-black text-slate-800">
                                ...
                                <span class="truncate"><?php echo e($createdBy); ?></span>
                            </div>
                        </div>

                        <div class="border-slate-200 xl:border-l xl:pl-5">
                            <p class="text-xs font-bold text-slate-500">Finance</p>
                            <p class="mt-1 text-2xl font-black <?php echo e($balanceDue > 0 ? 'text-slate-950' : 'text-emerald-700'); ?>">£<?php echo e(number_format($order->grand_total ?? 0, 2)); ?></p>
                            <p class="mt-1 text-sm font-bold <?php echo e($balanceDue > 0 ? 'text-rose-600' : 'text-slate-500'); ?>">Due £<?php echo e(number_format($balanceDue, 2)); ?></p>
                        </div>
                            ...
                            <div class="mt-2 space-y-2.5">
                                <div class="grid grid-cols-[30px_118px_minmax(80px,1fr)] items-center gap-2">
                                    ...
                                    <span class="text-sm font-black text-slate-800">
                                        ...
                                        <?php else: ?>
                                            <span class="text-emerald-700"><?php echo e($purchasedQty); ?>/<?php echo e($totalQty); ?></span> Purchased
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </span>
                                    <span class="h-2 rounded-full bg-slate-200"><span class="block h-2 rounded-full bg-emerald-600" style="width: <?php echo e($isCustomerSelfPurchase ? 100 : $purchasedPct); ?>%"></span></span>
                                </div>
                                <div class="grid grid-cols-[30px_118px_minmax(80px,1fr)] items-center gap-2">
                                    ...
                                    <span class="text-sm font-black text-slate-800"><span class="text-sky-700"><?php echo e($arrivedQty); ?>/<?php echo e($totalQty); ?></span> Arrived</span>
                                    <span class="h-2 rounded-full bg-slate-200"><span class="block h-2 rounded-full bg-sky-600" style="width: <?php echo e($arrivedPct); ?>%"></span></span>
                                </div>
                            </div>
                        </div>

                        <div class="grid grid-cols-2 gap-2 border-slate-200 sm:grid-cols-4 xl:border-l xl:pl-5">
                            <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="group rounded-2xl border border-slate-200 bg-white px-3 py-3 text-center shadow-sm transition hover:border-indigo-200 hover:bg-indigo-50">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($order->draft_order_id)): ?>
                                <a href="<?php echo e(route('draft-orders.show', $order->draft_order_id)); ?>" class="group rounded-2xl border border-slate-200 bg-white px-3 py-3 text-center shadow-sm transition hover:border-slate-300 hover:bg-slate-50">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($order->order_request_id)): ?>
                                <a href="<?php echo e(route('order-requests.show', $order->order_request_id)); ?>" class="group rounded-2xl border border-slate-200 bg-white px-3 py-3 text-center shadow-sm transition hover:border-amber-200 hover:bg-amber-50">
                                    ...
                                    <span class="mt-0.5 block truncate text-[11px] font-bold text-slate-500"><?php echo e($order->order_request_ref ?: 'View request'); ?> ↗</span>
                                </a>
                            <?php else: ?>
                                <span class="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-3 py-3 text-center opacity-60">
                            ...
                            <a href="<?php echo e(route('money-desk.orders.show', $order->id)); ?>" class="group rounded-2xl border border-slate-200 bg-white px-3 py-3 text-center shadow-sm transition hover:border-emerald-200 hover:bg-emerald-50">
...
<?php endif; ?>
<?php /**PATH /var/www/dabba-test/dabbadesk-v2/resources/views/orders/index.blade.php ENDPATH**/ ?>