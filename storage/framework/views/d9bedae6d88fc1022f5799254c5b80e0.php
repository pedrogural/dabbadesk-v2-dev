            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div class="grid grid-cols-3 gap-2 sm:min-w-[440px]">
                    <div class="rounded-2xl bg-indigo-50 p-3 ring-1 ring-indigo-100">
                        ...
                        <p class="mt-1 text-2xl font-black text-indigo-950"><?php echo e($summary['to_buy'] ?? 0); ?></p>
                    </div>
                    <div class="rounded-2xl bg-emerald-50 p-3 ring-1 ring-emerald-100">
                        ...
                        <p class="mt-1 text-2xl font-black text-emerald-950"><?php echo e($summary['purchases'] ?? 0); ?></p>
                    </div>
                    <div class="rounded-2xl bg-rose-50 p-3 ring-1 ring-rose-100">
                        ...
                        <p class="mt-1 text-2xl font-black text-rose-950"><?php echo e($summary['problems'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
