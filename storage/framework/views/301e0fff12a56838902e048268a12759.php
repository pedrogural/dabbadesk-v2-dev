<?php $__env->startSection('title', 'New order request ' . $reference); ?>
<?php $__env->startSection('subtitle', 'New web order received'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tr>
            <td style="padding:16px;">
                <p style="margin:0 0 8px;font-size:13px;"><strong>Name:</strong> <?php echo e($customerName ?: 'Not supplied'); ?></p>
                <p style="margin:0 0 8px;font-size:13px;"><strong>Email:</strong> <?php echo e($customerEmail ?: 'Not supplied'); ?></p>
                <p style="margin:0 0 8px;font-size:13px;"><strong>Phone:</strong> <?php echo e($customerPhone ?: 'Not supplied'); ?></p>
                <p style="margin:0;font-size:13px;"><strong>Address:</strong> <?php echo e($customerAddress ?: 'Not supplied'); ?></p>
            </td>
        </tr>
    </table>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($requestNotes ?? '')): ?>
        <div style="margin:20px 0;padding:16px;border:1px solid #fbbf24;border-radius:12px;background:#fffbeb;">
            ...
            <div style="white-space:pre-wrap;font-size:13px;line-height:1.6;color:#78350f;"><?php echo e($requestNotes); ?></div>
        </div>
...
<?php echo $__env->make('emails.layouts.dabba', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/dabba-live/dabbadesk-v2/resources/views/emails/staff/order-request-received.blade.php ENDPATH**/ ?>