    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('order-requests.create-manual') }}" class="rounded-2xl bg-purple-600 px-4 py-2 text-sm font-black text-white shadow-sm hover:bg-purple-700">+ New Request</a>
                <span class="rounded-full bg-indigo-100 px-4 py-2 text-sm font-bold text-indigo-700">{{ $newRequestCount }}
                    new</span>
            </div>
        </div>
    </x-slot>
                        ...
                        @forelse ($requests as $request)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-5 py-4 text-sm font-semibold text-gray-900">
                                    ...
                                    @if ($request->customer_company_name)
                                        <div class="text-xs font-normal text-gray-500">
                                            {{ $request->customer_company_name }}</div>
                                    @endif
                                </td>
                                ...
                                <td class="whitespace-nowrap px-5 py-4 text-right text-sm font-bold text-gray-900">
                                    £{{ number_format((float) $request->estimated_total, 2) }}</td>
