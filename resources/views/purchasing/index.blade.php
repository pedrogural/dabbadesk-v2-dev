            ...
            <form method="GET" action="{{ route('purchasing.index') }}" class="mt-5 border-t border-slate-100 pt-4">
                ...
                <div class="grid gap-3 lg:grid-cols-[1fr_auto] lg:items-center">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="{{ route('purchasing.index', ['tab' => 'to_buy', 'payment' => 'paid_or_part', 'q' => $filters['q'], 'mine' => ($filters['mine'] ?? false) ? 1 : null]) }}" class="rounded-2xl px-4 py-3 text-sm font-black ring-1 transition {{ $filters['payment'] === 'paid_or_part' ? 'bg-indigo-600 text-white ring-indigo-600' : 'bg-white text-slate-600 ring-slate-200 hover:bg-slate-50' }}">Paid & Part Paid</a>
                        <a href="{{ route('purchasing.index', ['tab' => 'to_buy', 'payment' => 'all', 'q' => $filters['q'], 'mine' => ($filters['mine'] ?? false) ? 1 : null]) }}" class="rounded-2xl px-4 py-3 text-sm font-black ring-1 transition {{ $filters['payment'] === 'all' ? 'bg-rose-600 text-white ring-rose-600' : 'bg-white text-slate-600 ring-slate-200 hover:bg-slate-50' }}">All Orders</a>
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                @if (($queueOrder['inspection_count'] ?? 0) > 0)
                            ...
                            <div class="mt-4 grid gap-3 text-sm sm:grid-cols-5">
                                ...
                                <div class="rounded-2xl bg-purple-50 p-3 ring-1 ring-purple-100">
                                    ...
                                    <p class="mt-1 font-black text-purple-800">{{ $queueOrder['inspection_count'] ?? 0 }}</p>
                                </div>
                                <div class="rounded-2xl bg-slate-50 p-3 ring-1 ring-slate-100">
