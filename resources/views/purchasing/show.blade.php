                            ...
                            <div class="divide-y divide-slate-100">
                                @foreach ($retailerItems as $item)
                                    ...
                                    <div class="grid gap-3 px-4 py-4 md:grid-cols-[48px_1fr_120px_120px_130px_70px] md:items-center {{ $canBuy ? 'bg-white' : 'bg-slate-50/70' }}">
                                        <div>
                                            @if ($canBuy)
                                                <input type="checkbox" name="order_item_ids[]" value="{{ $item->item_id }}" data-line-checkbox class="h-5 w-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500">
                                            @else
