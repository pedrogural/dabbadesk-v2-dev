                                        ...
                                        <div class="min-w-0">
                                            ...
                                            @if ($canBuy)
                                                <details class="mt-3 rounded-xl border border-amber-200 bg-amber-50/70 p-3">
                                                    ...
                                                    <form method="POST" action="{{ route('purchasing.problems.store') }}" class="mt-3 space-y-3">
                                                        @csrf
                                                        ...
                                                        <div class="grid gap-3 sm:grid-cols-[160px_120px_1fr_auto] sm:items-end">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input name="qty" type="number" min="1" max="{{ $remaining }}" value="{{ $remaining }}" required class="mt-1 h-10 w-full rounded-xl border-amber-200 bg-white px-3 text-xs font-black text-slate-900 focus:border-amber-400 focus:ring-amber-200">
                                                            </div>
                                                            <div>
