<x-app-layout>
    ...
    <style>
            ...
            .draft-ui textarea:not(.description-input){min-height:76px;line-height:1.5}
            ...
            .draft-ui .row-action{border:1px solid #cbd5e1;border-radius:14px;background:#fff;padding:0 15px;min-height:44px;font-size:13px;font-weight:900;color:#0f172a;box-shadow:0 1px 2px rgba(15,23,42,.04)}
            .draft-ui .row-action:hover{background:#f8fafc}

            .draft-ui .retailer-card{background:#fff}
            .draft-ui .retailer-header{display:grid;grid-template-columns:minmax(230px,1fr) 250px minmax(420px,1.65fr);gap:24px;align-items:center;padding:24px 28px;border-bottom:1px solid #e2e8f0}
            .draft-ui .retailer-identity{display:flex;align-items:center;gap:16px;min-width:0}
            .draft-ui .retailer-logo{height:64px;width:64px;border-radius:22px;object-fit:contain;background:#fff;border:1px solid #e2e8f0;padding:8px;box-shadow:0 2px 6px rgba(15,23,42,.08)}
            .draft-ui .retailer-initial{display:grid;place-items:center;height:64px;width:64px;border-radius:22px;background:#0f172a;color:#fff;font-size:24px;font-weight:950;flex:0 0 auto}
            .draft-ui .retailer-name{font-size:25px;font-weight:950;line-height:1.1;color:#020617;letter-spacing:-.025em}
            .draft-ui .retailer-subline{margin-top:8px;font-size:14px;font-weight:850;color:#64748b}

            .draft-ui .retailer-delivery-panel{border-left:1px solid #e2e8f0;padding-left:22px}
            .draft-ui .retailer-delivery-form{display:grid;grid-template-columns:minmax(0,1fr) 48px;gap:10px;align-items:end}
            .draft-ui .money-label{display:block;font-size:11px;font-weight:950;text-transform:uppercase;letter-spacing:.09em;color:#64748b;margin-bottom:7px}
            .draft-ui .money-tile-grid{display:grid;grid-template-columns:repeat(4,minmax(105px,1fr));gap:12px}
            .draft-ui .money-box{border-radius:18px;background:#f8fafc;padding:15px 16px;min-height:74px;display:flex;flex-direction:column;justify-content:center}
            .draft-ui .money-box-purple{background:#faf5ff;color:#7e22ce}
            .draft-ui .money-value{font-size:19px;font-weight:950;color:#020617;white-space:nowrap}
            .draft-ui .money-box-purple .money-label,.draft-ui .money-box-purple .money-value{color:#7e22ce}

            .draft-ui .currency-input-wrap{display:flex;align-items:center;border:1px solid #cbd5e1;border-radius:14px;background:#fff;min-height:48px;overflow:hidden;box-shadow:0 1px 2px rgba(15,23,42,.04)}
            .draft-ui .currency-input-wrap:focus-within{border-color:#9333ea;box-shadow:0 0 0 3px rgba(147,51,234,.18)}
            .draft-ui .currency-prefix{height:48px;display:flex;align-items:center;padding-left:14px;padding-right:10px;font-weight:900;color:#64748b;background:#f8fafc;border-right:1px solid #e2e8f0}
            .draft-ui .currency-input{appearance:textfield;border:0!important;box-shadow:none!important;border-radius:0!important;min-height:46px!important;padding:0 12px!important;text-align:right;font-weight:900;color:#0f172a;background:transparent!important;width:100%}
            .draft-ui .currency-input::-webkit-outer-spin-button,.draft-ui .currency-input::-webkit-inner-spin-button{appearance:none;margin:0}
            .draft-ui .currency-input:focus{box-shadow:none!important;border:0!important;outline:none!important}
            .draft-ui .save-btn{display:grid;place-items:center;height:48px;width:48px;border-radius:14px;border:1px solid #7e22ce;background:#9333ea;color:white;font-weight:950;transition:.15s;box-shadow:0 8px 16px rgba(147,51,234,.18)}
            .draft-ui .save-btn:hover{background:#7e22ce}

            .draft-ui .basket-scroll{overflow-x:auto}
            .draft-ui .basket-grid{display:grid;grid-template-columns:56px minmax(340px,1fr) 96px 146px 160px 138px 62px;gap:16px;align-items:start;min-width:1060px}
            .draft-ui .basket-grid-head{align-items:center;background:#f8fafc;border-bottom:1px solid #e2e8f0;color:#64748b;font-size:12px;font-weight:950;letter-spacing:.08em;text-transform:uppercase;padding:15px 28px}
            .draft-ui .basket-row{padding:20px 28px;border-bottom:1px solid #e2e8f0;background:#fff}
            .draft-ui .basket-row:last-child{border-bottom:0}
            .draft-ui .row-number{display:grid;place-items:center;width:44px;height:44px;border:1px solid #dbe4ef;border-radius:14px;background:#fff;font-weight:950;color:#0f172a;font-size:16px}
            .draft-ui .item-description-card{border:1px solid #cbd5e1;border-radius:14px;background:#fff;padding:12px 14px;box-shadow:0 1px 2px rgba(15,23,42,.04)}
            .draft-ui .item-description-card:focus-within{border-color:#9333ea;box-shadow:0 0 0 3px rgba(147,51,234,.18)}
            .draft-ui .description-input{width:100%;min-height:62px!important;max-height:120px;resize:vertical;border:0!important;border-radius:0!important;background:transparent!important;padding:0!important;box-shadow:none!important;font-size:14px!important;line-height:1.55!important;font-weight:650!important;color:#64748b!important;overflow:auto}
            .draft-ui .description-input:focus{border:0!important;box-shadow:none!important;outline:none!important}
            .draft-ui .url-edit-row{display:flex;align-items:stretch;gap:8px;margin-top:10px;width:100%}
            .draft-ui .url-input{margin-top:0;width:100%;flex:1 1 auto;border-radius:14px!important;border:1px solid #dbe4ef!important;background:#fff!important;padding:11px 14px!important;font-size:13px!important;font-weight:800!important;color:#7e22ce!important;min-height:44px!important;box-shadow:0 1px 2px rgba(15,23,42,.04)!important}
            .draft-ui .url-open-btn{flex:0 0 44px;display:grid;place-items:center;height:44px;border-radius:14px;border:1px solid #dbe4ef;background:#fff;color:#475569;font-size:20px;font-weight:950;text-decoration:none;box-shadow:0 1px 2px rgba(15,23,42,.04);transition:.15s}
            .draft-ui .url-open-btn:hover{border-color:#9333ea;color:#7e22ce;box-shadow:0 0 0 3px rgba(147,51,234,.12)}
            .draft-ui .url-input:focus{border-color:#9333ea!important;box-shadow:0 0 0 3px rgba(147,51,234,.18)!important;outline:none!important}
            .draft-ui .sku-input{margin-top:10px;width:100%;max-width:420px;border-radius:14px!important;border:1px solid #dbe4ef!important;background:#fff!important;padding:11px 14px!important;font-size:14px!important;font-weight:800!important;color:#64748b!important;min-height:44px!important;box-shadow:0 1px 2px rgba(15,23,42,.04)!important}
            .draft-ui .save-state{display:inline-flex;align-items:center;gap:6px;margin-top:8px;font-size:11px;font-weight:950;color:#64748b}
            .draft-ui .save-state-dot{height:7px;width:7px;border-radius:999px;background:#94a3b8}
            .draft-ui .save-state[data-state=dirty]{color:#ca8a04}.draft-ui .save-state[data-state=dirty] .save-state-dot{background:#f59e0b}
            .draft-ui .save-state[data-state=saving]{color:#7e22ce}.draft-ui .save-state[data-state=saving] .save-state-dot{background:#9333ea;animation:pulse 1s infinite}
            .draft-ui .save-state[data-state=saved]{color:#16a34a}.draft-ui .save-state[data-state=saved] .save-state-dot{background:#22c55e}
            .draft-ui .save-state[data-state=error]{color:#dc2626}.draft-ui .save-state[data-state=error] .save-state-dot{background:#ef4444}
            .draft-ui .toast-card{border-left:4px solid #22c55e}
            .draft-ui .compact-input{width:100%;border:1px solid #cbd5e1!important;border-radius:14px!important;min-height:48px!important;padding:11px 13px!important;text-align:center;font-weight:900;color:#0f172a;background:#fff!important;box-shadow:0 1px 2px rgba(15,23,42,.04)!important}
            .draft-ui .readonly-total{display:flex;align-items:center;justify-content:center;min-height:48px;border-radius:14px;border:1px solid #e2e8f0;background:#f8fafc;font-weight:950;color:#0f172a}
            .draft-ui .micro-help{margin-top:7px;font-size:11px;font-weight:800;line-height:1.35;color:#94a3b8}
            .draft-ui .trash-btn{display:inline-grid;place-items:center;width:44px;height:44px;border-radius:14px;border:1px solid #fecaca;background:#fff;color:#ef4444;font-weight:950;transition:.15s}
            .draft-ui .trash-btn:hover{background:#fef2f2;border-color:#fca5a5;color:#dc2626}
            .draft-ui .row-label{display:none;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.08em;color:#64748b;margin-bottom:7px}
            .draft-ui .autosave-hint{display:inline-flex;align-items:center;gap:6px;margin-top:8px;font-size:11px;font-weight:900;color:#64748b}
            .draft-ui .autosave-dot{height:7px;width:7px;border-radius:999px;background:#22c55e}
            .draft-ui details > summary{cursor:pointer;list-style:none}
            .draft-ui details > summary::-webkit-details-marker{display:none}
            @media(max-width:1500px){
                .draft-ui .retailer-header{grid-template-columns:minmax(210px,1fr) 230px minmax(360px,1.5fr);gap:16px;padding:22px}
                .draft-ui .money-tile-grid{gap:10px}.draft-ui .money-box{padding:13px 14px}.draft-ui .money-value{font-size:17px}
                .draft-ui .basket-grid{grid-template-columns:52px minmax(310px,1fr) 86px 132px 146px 126px 56px;gap:13px;min-width:960px}.draft-ui .basket-row,.draft-ui .basket-grid-head{padding-left:22px;padding-right:22px}
            }
            @media(max-width:1180px){
                .draft-ui .retailer-header{display:block}.draft-ui .retailer-delivery-panel{margin-top:18px;border-left:0;padding-left:0}.draft-ui .money-tile-grid{margin-top:18px;grid-template-columns:repeat(2,minmax(0,1fr))}
            }
            @media(max-width:900px){
                .draft-ui .basket-grid,.draft-ui .basket-grid-head{display:block;min-width:0}.draft-ui .basket-grid-head{display:none}.draft-ui .basket-row{display:grid;gap:12px}.draft-ui .row-label{display:block}.draft-ui .row-number{margin-bottom:8px}
            }
        </style>
    ...
    <div
        ...
        x-init="boot()" @delete-item.window="deleteModal = { open: true, url: $event.detail.url, title: $event.detail.title }"
    >
        @if ($errors->any())
        ...
        @if (session('success'))
            <div x-data="{ show: true }" x-show="show" x-transition class="fixed bottom-6 right-6 z-50 w-[360px] max-w-[calc(100vw-2rem)] rounded-3xl border border-emerald-200 bg-white p-4 shadow-2xl">
                <div class="flex gap-3">
                    <div class="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-emerald-50 text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5"><path d="M20 6 9 17l-5-5"/></svg>
                    </div>
                    <div class="min-w-0 flex-1">
                        <p class="font-black text-slate-950">Saved</p>
                        <p class="mt-1 text-sm text-slate-500">{{ session('success') }}</p>
                    </div>
                    <button type="button" @click="show=false" class="rounded-xl px-2 text-slate-400 hover:bg-slate-100 hover:text-slate-700">✕</button>
                </div>
            </div>
        @endif
                    ...
                    <section class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                        <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 p-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">Retailer delivery is one editable retailer-level charge. Seller delivery stays per item for marketplace sellers like Amazon/eBay.</p>
                            </div>
                            <div class="flex gap-2">
                        ...
                        <div class="divide-y divide-slate-200">
                            @forelse ($groupedItems as $retailerId => $retailerItems)
                                @php
                                    ...
                                    $goodsTotal = round((float) ($summary->retailer_subtotal ?? $retailerItems->sum('line_subtotal')), 2);
                                    $sellerDeliveryTotal = round((float) $retailerItems->sum(fn ($row) => (float) ($row->item_retailer_delivery_fee ?? $row->item_delivery_fee ?? 0)), 2);
                                    $retailerDeliveryFee = round((float) ($summary->retailer_delivery_fee_total ?? 0), 2);
                                    $dabbaFee = round((float) ($summary->dabba_fee ?? 0), 2);
                                    $retailerGrand = round($goodsTotal + $sellerDeliveryTotal + $retailerDeliveryFee + $dabbaFee, 2);
                                @endphp
                                <section x-data="{ open: true }" class="retailer-card">
                                    <div class="retailer-header">
                                        <button type="button" @click="open=!open" class="retailer-identity text-left">
                                            @if ($logoUrl)
                                                <span class="relative inline-grid h-16 w-16 shrink-0 place-items-center">
                                                    <img src="{{ $logoUrl }}" alt="{{ $retailerName }} logo" class="retailer-logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='grid';">
                                                    <span class="retailer-initial absolute inset-0 hidden">{{ $initial }}</span>
                                                </span>
                                            @else
                                            ...
                                            <span class="min-w-0">
                                                ...
                                                <span class="retailer-subline block">
                                                    {{ $retailerItems->count() }} {{ Str::plural('item', $retailerItems->count()) }}
                                        ...
                                        <div class="retailer-delivery-panel">
                                            <form method="POST" action="{{ route('draft-orders.retailers.delivery.update', [$draft->id, $retailerId]) }}" class="retailer-delivery-form">
                                                @csrf
                                                @method('PATCH')
                                                <div>
                                                    ...
                                                    <div class="currency-input-wrap">
                                                        ...
                                                        <input name="retailer_delivery_fee_total" value="{{ number_format($retailerDeliveryFee, 2, '.', '') }}" type="number" min="0" step="0.01" class="currency-input" aria-label="Retailer delivery fee">
                                                    </div>
                                                </div>
                                                <button type="submit" class="save-btn" title="Save retailer delivery fee" aria-label="Save retailer delivery fee">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5"><path d="M20 6 9 17l-5-5"/></svg>
                                                </button>
                                            </form>
                                        </div>

                                        <div class="money-tile-grid">
                                            <div class="money-box"><span class="money-label">Goods</span><span class="money-value">{{ $money($goodsTotal) }}</span></div>
                                            <div class="money-box"><span class="money-label">Seller delivery</span><span class="money-value">{{ $money($sellerDeliveryTotal) }}</span></div>
                                            <div class="money-box"><span class="money-label">Dabba fee</span><span class="money-value">{{ $money($dabbaFee) }}</span></div>
                                            <div class="money-box money-box-purple"><span class="money-label">Retailer total</span><span class="money-value">{{ $money($retailerGrand) }}</span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="open" x-collapse>
                                        <div class="basket-scroll">
                                            <div class="basket-grid basket-grid-head">
                                                ...
                                                <div>Qty</div>
                                                <div>Unit price</div>
                                                <div>Seller delivery <span title="Per-item delivery from marketplace sellers like Amazon/eBay">ⓘ</span></div>
                                                <div>Line total</div>
                                            ...
                                            @foreach ($retailerItems as $item)
                                                @php
                                                    $lineTotal = (float) ($item->line_total ?? (($item->qty ?? 1) * ($item->unit_price ?? 0) + ($item->item_retailer_delivery_fee ?? $item->item_delivery_fee ?? 0)));
                                                ...
                                                <form
                                                    ...
                                                    x-data="{
                                                        ...
                                                        markDirty(){ this.saveState = 'dirty'; this.saveMessage = 'Unsaved changes'; },
                                                        queueSave(){ this.markDirty(); clearTimeout(this.saveTimer); this.saveTimer = setTimeout(() => this.save(), 350); },
                                                        async save(){
                                                ...
                                                >
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <div class="item-description-card">
                                                            <textarea name="description" rows="3" @input="markDirty()" @blur="save()" class="description-input">{{ $item->description }}</textarea>
                                                        </div>
                                                        <label class="mt-3 block text-[10px] font-black uppercase tracking-widest text-slate-400">Product URL</label>
                                                        <div class="url-edit-row">
                                                            <input name="url" value="{{ $item->url }}" @input="markDirty()" @blur="save()" placeholder="Product URL — changing this can switch retailer after resolving" class="url-input">
                                                            @if ($item->url)
                                                                <a href="{{ $item->url }}" target="_blank" rel="noopener" class="url-open-btn" title="Open product URL" aria-label="Open product URL">↗</a>
                                                            @endif
                                                        </div>
                                                        <input name="product_code" value="{{ $item->product_code }}" @input="markDirty()" @blur="save()" placeholder="SKU / product code" class="sku-input">
                                                        <span class="save-state" :data-state="saveState"><span class="save-state-dot"></span><span x-text="saveMessage"></span></span>
                                                    </div>

                                                    <div>
                                                        <label class="row-label">Qty</label>
                                                        <input name="qty" x-model.number="qty" value="{{ (int) $item->qty }}" @input="queueSave()" @blur="save()" type="number" min="1" class="compact-input">
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="currency-input-wrap">
                                                            <span class="currency-prefix">£</span>
                                                            <input name="unit_price" x-model.number="unit" value="{{ number_format((float) $item->unit_price, 2, '.', '') }}" @focus="if (Number(unit) === 0) unit = ''" @input="queueSave()" @blur="if (unit === '' || unit === null) unit = 0; save()" type="number" min="0" step="0.01" class="currency-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="currency-input-wrap">
                                                            <span class="currency-prefix">£</span>
                                                            <input name="item_retailer_delivery_fee" x-model.number="delivery" value="{{ number_format((float) ($item->item_retailer_delivery_fee ?? $item->item_delivery_fee ?? 0), 2, '.', '') }}" @focus="if (Number(delivery) === 0) delivery = ''" @input="queueSave()" @blur="if (delivery === '' || delivery === null) delivery = 0; save()" type="number" min="0" step="0.01" class="currency-input">
                                                        </div>
                                                        <p class="micro-help">For Amazon/eBay marketplace seller fees</p>
                                                    </div>

                                                    <div>
                                                        <label class="row-label">Line total</label>
                                                        <div class="readonly-total" x-text="'£' + total"></div>
                                                        <p class="micro-help">Qty × unit + delivery</p>
                                                    </div>

                                                    <div class="flex items-start justify-center">
                                                        <button type="button" @click.prevent="$dispatch('delete-item', { url: '{{ route('draft-orders.items.destroy', [$draft->id, $item->id]) }}', title: @js(Str::limit($title, 90)) })" class="trash-btn" title="Remove item" aria-label="Remove item">
                                        ...
                                        <div class="flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 bg-slate-50 px-6 py-4">
                                            ...
                                            <div class="flex flex-wrap items-center gap-6 text-sm font-black text-slate-500">
                                                ...
                                                <span class="text-purple-700">Retailer total: {{ $money($retailerGrand) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </section>
        ...
        <div x-show="deleteModal.open" x-cloak class="fixed inset-0 z-50 grid place-items-center bg-slate-950/40 p-4" @keydown.escape.window="deleteModal.open=false">
            <div @click.outside="deleteModal.open=false" class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl">
                <div class="flex items-start gap-4">
                    <div class="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-rose-50 text-rose-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6"><path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/></svg>
                    </div>
                    <div class="min-w-0">
                        <h2 class="text-xl font-black text-slate-950">Remove item?</h2>
                        <p class="mt-2 text-sm leading-6 text-slate-600">This will remove <strong x-text="deleteModal.title"></strong> from the draft basket.</p>
                    </div>
                </div>
                <div class="mt-6 flex justify-end gap-3">
                    <button type="button" @click="deleteModal.open=false" class="rounded-2xl border border-slate-200 px-5 py-3 text-sm font-black text-slate-700 hover:bg-slate-50">Cancel</button>
                    <button type="button" @click="confirmDeleteItem()" class="rounded-2xl bg-rose-600 px-5 py-3 text-sm font-black text-white hover:bg-rose-700">Remove item</button>
                </div>
            </div>
        </div>


        <div x-show="toast.open" x-cloak class="fixed bottom-6 right-6 z-50 w-full max-w-sm rounded-3xl border border-slate-200 bg-white p-5 shadow-2xl toast-card" x-transition>
            <div class="flex items-start gap-3">
                <div class="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-emerald-50 text-emerald-600">✓</div>
                <div class="min-w-0">
                    <div class="text-sm font-black text-slate-950" x-text="toast.title"></div>
                    <div class="mt-1 text-sm text-slate-500" x-text="toast.message"></div>
                </div>
                <button type="button" @click="toast.open=false" class="ml-auto rounded-xl px-2 py-1 text-slate-400 hover:bg-slate-100">✕</button>
            </div>
        </div>
    ...
    <script>
        window.dabbaDraftAutosave = async function(form) {
            ...
            try {
                if (!(form instanceof HTMLFormElement)) {
                    ...
                    return {
                        ok: false,
                        message: 'Autosave setup error: expected form element, got ' + (form ? form.constructor?.name : 'nothing') + '.',
                    };
                }
                ...
                if (!response.ok || payload.ok === false) {
                    ...
                    return {
                        ok: false,
                        message: firstValidationError || payload.message || payload.error || `Autosave failed with HTTP ${response.status}.`,
                    };
                }
        ...
        function draftWorkspace(config) {
            return {
                ...
                deleteModal: { open: false, url: '', title: '' },
