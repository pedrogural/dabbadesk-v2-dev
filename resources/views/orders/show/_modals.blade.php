        ...
        <div x-data="{ refundOpen: false }" @open-refund-modal.window="refundOpen = true" x-cloak x-show="refundOpen" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
        ...
        <div x-data="{ creditOpen: false }" @open-credit-modal.window="creditOpen = true" x-cloak x-show="creditOpen" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
